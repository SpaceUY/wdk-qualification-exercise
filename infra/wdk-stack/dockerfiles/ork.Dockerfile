...
COPY --from=entrypoints ork.entrypoint.js ./docker-entrypoint.js
...
USER 65532:65532
EXPOSE 8080
LABEL org.opencontainers.image.title="wdk-ork-wrk" \
      org.opencontainers.image.description="WDK ORK directory/routing layer (master + secondaries)" \
      org.opencontainers.image.source="https://github.com/SpaceUY/wdk-ork-wrk" \
